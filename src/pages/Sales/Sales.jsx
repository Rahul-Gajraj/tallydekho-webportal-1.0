...
const kpiData = [
  ...
  },
  {
    title: "Credit Notes",
    price: "3",
    img: <img src="/media/icons/credit_notes.svg" className="w-5" />,
  },
];
  ...
  return (
    <div className="mx-5 overflow-y-scroll">
      ...
      <section className="mx-auto">
        <div className="mt-8 grid xl:grid-cols-6 lg:grid-cols-4 md:grid-cols-2 grid-cols-1 items-center gap-4">
          {kpiData.map((data) => (
            <div
              key={data.title}
