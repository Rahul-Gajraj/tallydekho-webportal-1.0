              ...
              ({ head, customeStyle, value }, index) => (
                ...
                >
                  <div className="flex">
                    ...
                    >
                      {head}
                      {index < BANK_REGISTER_TABLE_HEAD.length - 2 && (
                        <ChevronUpDownIcon
                          strokeWidth={2}
                          className="h-4 w-4"
                        />
          ...
          <tbody>
            {[...Array(3)].map((_, index) => (
              <tr key={index} className="animate-pulse">
                {BANK_REGISTER_TABLE_HEAD.map((_, idx) => (
...
export default BankRegisterFilterTable;
