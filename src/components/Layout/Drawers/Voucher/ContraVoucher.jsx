...
const ContraVoucherDrawer = ({ open, toggleDrawer }) => {
  const {
    register,
    handleSubmit,
    formState: { errors },
  ...
  const [fromLedger, setCustomers] = useState(["Yash", "Shirish", "Manish"]);
  const [paymentMethods, setPaymentMethods] = useState(["Bank", "Cash", "UPI"]);

  const [toLedger, setReferenceInvoice] = useState([
    "Aadhar",
    "Pancard",
    "Passport",
  ]);
  ...
  return (
    <>
      <Drawer
        ...
        open={open}
        // onClose={() => toggleDrawer("contraVoucher")}
        size={500}
      >
        <form onSubmit={handleSubmit(onSubmitHandler)}>
          <div className="relative mt-0 flex justify-between">
            ...
            <IconButton
              size="sm"
              variant="text"
              onClick={() => toggleDrawer("contraVoucher")}
            >
              <svg
          ...
          <div className="space-y-4 pb-6 pt-5">
            <div className="grid grid-cols-12 gap-5">
              ...
              <div className="col-span-12">
                ...
                />
                <Error
                  condition={errors.fromLedger}
                  message={errors.fromLedger?.message}
                />
              </div>
              <div className="col-span-12">
                <Controller
                ...
                />
                <Error
                  condition={errors.toLedger}
                  message={errors.toLedger?.message}
                />
              </div>
              <div className="col-span-12">
                <Controller
...
export default ContraVoucherDrawer;
